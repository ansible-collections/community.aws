    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Information about a parameter.</div>
                            <div>Does not include the value of the parameter as this can be sensitive information.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Time and date that the parameter was last modified.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>ARN of the last user to modify the parameter.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A list of policies associated with a parameter.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>success</td>
                <td>
                            <div>The status of the policy.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The JSON text of the policy.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Parameter version number</div>
                    <br/>
                </td>
            </tr>
