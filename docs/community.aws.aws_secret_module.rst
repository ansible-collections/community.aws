    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when the secret has a description</td>
                <td>
                            <div>A description of the secret.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">An example description</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>when the secret has tags</td>
                <td>
                            <div>A list of dictionaries representing the tags associated with the secret in the standard boto3 format.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>success</td>
                <td>
                            <div>The name or key of the tag.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>when the secret has tags</td>
                <td>
                            <div>A dictionary representing the tags associated with the secret.</div>
                    <br/>
                </td>
            </tr>
            <tr>
