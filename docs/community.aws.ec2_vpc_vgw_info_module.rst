    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A dictionary representing the tags attached to the VGW.</div>
                            <div>Represents the same details as <em>tags</em>.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The current state of the VGW.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A list of dictionaries representing the tags attached to the VGW.</div>
                            <div>Represents the same details as <em>resource_tags</em>.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The type of VPN connection the VGW supports.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A description of the attachment of VPCs to the VGW.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
