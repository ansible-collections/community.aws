    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The instruction set architecture that the function supports.</div>
                        <div>Requires one of <em>s3_bucket</em> or <em>zip_file</em>.</div>
                        <div>Requires botocore &gt;= 1.21.51.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: architectures</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
