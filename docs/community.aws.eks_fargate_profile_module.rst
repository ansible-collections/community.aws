.. _community.aws.eks_fargate_profile_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Name of EKS Fargate Profile.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>A list of selectors to use in fargate profile.</div>
                        <div>Required when <em>state=present</em>.</div>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                        <div>A dictionary of labels used in fargate profile.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>A namespace used in fargate profile.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Create or delete the Fargate Profile.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Specifies whether the module waits until the profile is created or deleted before moving on.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">test-cluster</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>when state is present</td>
                <td>
                            <div>Fargate Profile creation date and time.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2022-01-18T20:00:00.111000+00:00</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>fargate_profile_arn</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                    </div>
                ...
                <td>when state is present</td>
                <td>
                            <div>ARN of the Fargate Profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:eks:us-east-1:1231231123:safd</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>when state is present</td>
                <td>
                            <div>Name of Fargate Profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">test_profile</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>when state is present</td>
                <td>
                            <div>ARN of the IAM Role used by Fargate Profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:eks:us-east-1:1231231123:role/asdf</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>when state is present</td>
                <td>
                            <div>Selector configuration.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when state is present</td>
                <td>
                            <div>List of kubernetes labels used in profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;label1&#x27;: &#x27;test1&#x27;}, {&#x27;label2&#x27;: &#x27;test2&#x27;}]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>when state is present</td>
                <td>
                            <div>Name of the kubernetes namespace used in profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">nm-test</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>when state is present</td>
                <td>
                            <div>status of the EKS Fargate Profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>when state is present</td>
                <td>
                            <div>List of subnets used in Fargate Profile.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;subnet-qwerty123&#x27;, &#x27;subnet-asdfg456&#x27;]</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;foo&#x27;: &#x27;bar&#x27;, &#x27;env&#x27;: &#x27;test&#x27;}</div>
                </td>
            </tr>
    </table>
    <br/><br/>
