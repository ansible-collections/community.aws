    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A dictionary representing the tags to be applied to the newly created resource.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Wait for the copied Snapshot to be in the <code>Available</code> state before returning.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
