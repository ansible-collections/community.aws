.. _community.aws.networkfirewall_policy_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A description for the Network Firewall policy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>purge_stateless_custom_actions</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>If <em>purge_stateless_custom_actions=true</em>, existing custom actions will be purged from the resource to match exactly what is defined by the <em>stateless_custom_actions</em> parameter.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: purge_custom_stateless_actions</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Create or remove the Network Firewall policy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>stateful_default_actions</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                ...
                <td>
                        <div>Actions to take on a packet if it doesn&#x27;t match any of the stateful rules in the policy.</div>
                        <div>Common actions are <code>aws:drop_strict</code>, <code>aws:drop_established</code>, <code>aws:alert_strict</code> and <code>aws:alert_established</code>.</div>
                        <div>Only valid for policies where <em>strict_rule_order=true</em>.</div>
                        <div>When creating a new policy defaults to <code>aws:drop_strict</code>.</div>
                        <div><em>stateful_default_actions</em> requires botocore&gt;=1.21.52.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>stateful_rule_groups</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>
                ...
                <td>
                        <div>A list of names or ARNs of stateful firewall rule groups.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: stateful_groups</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>stateful_rule_order</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>Indicates how to manage the order of stateful rule evaluation for the policy.</div>
                        <div>When <em>strict_rule_order=&#x27;strict&#x27;</em> rules and rule groups are evaluated in the order that they&#x27;re defined.</div>
                        <div>Cannot be updated after creation.</div>
                        <div><em>stateful_rule_order</em> requires botocore&gt;=1.21.52.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: rule_order</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>A list of dictionaries defining custom actions which can be used in <em>stateless_default_actions</em> and <em>stateless_fragment_default_actions</em>.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: custom_stateless_actions</div>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                        <div>The name of the custom action.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>publish_metric_dimension_value</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>When the custom action is used, metrics will have a dimension of <code>CustomAction</code> the value of which is set to <em>publish_metric_dimension_value</em>.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: publish_metric_dimension_values</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Actions to take on a packet if it doesn&#x27;t match any of the stateless rules in the policy.</div>
                        <div>Common actions are <code>aws:pass</code>, <code>aws:drop</code> and <code>aws:forward_to_sfe</code>.</div>
                        <div>When creating a new policy defaults to <code>aws:forward_to_sfe</code>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>Actions to take on a fragmented UDP packet if it doesn&#x27;t match any of the stateless rules in the policy.</div>
                        <div>Common actions are <code>aws:pass</code>, <code>aws:drop</code> and <code>aws:forward_to_sfe</code>.</div>
                        <div>When creating a new policy defaults to <code>aws:forward_to_sfe</code>.</div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                        <div>A list of names or ARNs of stateless firewall rule groups.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: stateless_groups</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Whether to wait for the firewall policy to reach the <code>ACTIVE</code> or <code>DELETED</code> state before the module returns.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>Maximum time, in seconds, to wait for the firewall policy to reach the expected state.</div>
