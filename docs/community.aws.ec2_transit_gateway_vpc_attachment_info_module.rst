.. _community.aws.ec2_transit_gateway_vpc_attachment_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A dictionary of filters to apply. Each dict item consists of a filter key and a filter value.</div>
                        <div>Setting a <code>tag:Name</code> filter will override the <em>name</em> parameter.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div>Mutually exclusive with <em>name</em> and <em>filters</em></div>
            ...
            <tr>
                ...
                <td>
                        <div>If <em>include_deleted=True</em>, then attachments in a deleted state will also be returned.</div>
                        <div>Setting a <code>state</code> filter will override the <em>include_deleted</em> parameter.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
