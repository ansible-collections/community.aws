    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The BGP ASN on the Amazon side.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The ID of a VPC to attach or detach to the VGW.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A description of the VGW</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The type of VPN connection the virtual private gateway supports.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The ID of the VPC to which the VGW is attached.</div>
                    <br/>
                </td>
            </tr>
