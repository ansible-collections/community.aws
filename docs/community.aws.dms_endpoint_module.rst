    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A description of the DMS endpoint.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>success</td>
                <td>
                            <div>The name of the database at the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>dms_transfer_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when additional DMS Transfer settings have been configured.</td>
                <td>
                            <div>Additional transfer related settings.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>documentdb</code></td>
                <td>
                            <div>Additional settings for DocumentDB endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>elasticsearch_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>elasticsearch</code></td>
                <td>
                            <div>Additional settings for Elasticsearch endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The ARN that uniquely identifies the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The database endpoint identifier.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The type of endpoint. Valid values are <code>SOURCE</code> and <code>TARGET</code>.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The expanded name for the engine name.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The database engine name.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>i_b_m_db_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>db2</code></td>
                <td>
                            <div>Additional settings for IBM DB2 endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>kafka</code></td>
                <td>
                            <div>Additional settings for Kafka endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>kinesis_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>kinesis</code></td>
                <td>
                            <div>Additional settings for Kinesis endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>An KMS key ID that is used to encrypt the connection parameters for the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>microsoft_sql_server_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>sqlserver</code></td>
                <td>
                            <div>Additional settings for Microsoft SQL Server endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>mongo_db_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>mongodb</code></td>
                <td>
                            <div>Additional settings for MongoDB endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>mysql</code></td>
                <td>
                            <div>Additional settings for MySQL endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>neptune_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>neptune</code></td>
                <td>
                            <div>Additional settings for Amazon Neptune endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>oracle</code></td>
                <td>
                            <div>Additional settings for Oracle endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The port used to access the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>postgre_sql_settings</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">dictionary</span>
                    </div>
                </td>
                <td>when the <em>endpoint_type</em> is <code>postgres</code></td>
                <td>
                            <div>Additional settings for PostgrSQL endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>redshift</code></td>
                <td>
                            <div>Additional settings for Redis endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>redshift</code></td>
                <td>
                            <div>Additional settings for Redshift endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>s3</code></td>
                <td>
                            <div>Additional settings for S3 endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The name of the server at the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The SSL mode used to connect to the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when the <em>endpoint_type</em> is <code>sybase</code></td>
                <td>
                            <div>Additional settings for Sybase endpoints.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A dictionary representing the tags attached to the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The user name used to connect to the endpoint.</div>
                    <br/>
                </td>
            </tr>
