...
def format_egress_only_internet_gateway(internet_gateway: Dict[str, Any], convert_tags: bool) -> Dict[str, Any]:
    if convert_tags:
    ...
    return camel_dict_to_snake_dict(egress_only_igw, ignore_list=ignore_list)
...
def list_egress_only_internet_gateways(connection, module: AnsibleAWSModule) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        return [format_egress_only_internet_gateway(igw, convert_tags) for igw in egress_only_igws]
