        ...
        suboptions:
          ...
          headers:
            description:
              ...
              - For more information see the CloudFront documentation at
                U(https://docs.aws.amazon.com/cloudfront/latest/APIReference/API_Headers.html)
            type: list
            elements: str
            required: false
      cookies_config:
        ...
        suboptions:
          cookie_behavior:
            description:
              - Determines whether any cookies in viewer requests are included
...
class CloudfrontCachePolicyService(object):
    ...
    def find_cache_policy(self, name):
        try:
            ...
            policies = self.client.list_cache_policies(Type="custom")["CachePolicyList"]["Items"]
