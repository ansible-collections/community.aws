...
options:
  ...
  filters:
    ...
    suboptions:
      ...
      tgw:
        description:
          - The transit gateway as a string.
      tag-keys:
        description:
...
transit_gateway_id:
  description: The transit gateway connected via the connection.
  type: str
  returned: I(state=present)
  sample:
...
def create_connection(connection, customer_gateway_id, static_only, transit_gateway_id, connection_type, max_attempts, delay, tunnel_options=None):
