...
from ansible_collections.community.aws.plugins.modules import ec2_imagebuilder_component
...
class TestEC2ImageBuilderComponentModule(ModuleTestCase):
    ...
    def test_present_when_not_exists(self, client_mock):
        ...
        args = {k: test_component[k] for k in ('name', 'description', 'platform', 'data', 'tags')}
        args.update({
    ...
    def test_present_when_component_different(self, client_mock):
        ...
        updated_test_component = dict(test_component)
        updated_test_component.update({
            'version': "1.0.1",
        ...
        args = {k: updated_test_component[k]
                for k in ('name', 'description', 'platform', 'data', 'tags')}
        args.update({
